...
export const AUTH_ERROR_MESSAGES: Record<AuthErrorCode, string> = {
  [AUTH_ERROR_CODES.INVALID_CREDENTIALS]: "Invalid username or password. Please check your credentials and try again.",
  [AUTH_ERROR_CODES.MISSING_CREDENTIALS]: "Username and password are required to sign in.",
